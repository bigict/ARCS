...
public:
	...
	Kmer_Short(unsigned long, unsigned long, unsigned long);
	Kmer get_next_kmer(unsigned int i) const;
	Kmer_Short get_binary_code() const;
	Kmer_Short get_next_short(unsigned int i) const;
	Kmer_Short get_next_short() const;
