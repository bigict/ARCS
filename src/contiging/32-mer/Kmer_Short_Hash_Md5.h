...
{
	Kmer_Short_Node(const Kmer_Short &km, int index=0, unsigned short numb=0):kmer_short(km){
	...
	void set(int index, unsigned short numb){
		num[index] = numb;
	}
...
{
public:
	Kmer_Short_Hash_Md5(unsigned int half_first_alloc=512000);
